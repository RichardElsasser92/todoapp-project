...
import application.splash.Splash_Controller;
import application.splash.Splash_Model;
import application.splash.Splash_View;
...
public class Main extends Application {
    ...
    public void startApp() {
        ...
        view = new Client_View(appStage, model);
        new Client_Controller(model, view);
